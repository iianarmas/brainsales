  ...
  if (!targetProductId) {
    return (
      <div className="text-center py-12">
        <p className="text-foreground/40">Please select a product to view competitive intelligence.</p>
      </div>
    );
  }
          ...
          <div className="bg-background rounded-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto shadow-2xl border border-border">
            <div className="p-6">
              ...
              <button
                ...
                className="mt-4 w-full py-2 text-sm text-foreground/40 hover:text-foreground/70 transition-colors"
              >
                Close
              </button>
            </div>
      ...
      {lowerQuery && filteredCompetitors.length === 0 && filteredUpdates.length === 0 ? (
        ...
        <div className="space-y-4">
          ...
          {unassignedUpdates.length > 0 && (
            <div className="mt-6">
              <h3 className="text-sm font-medium text-foreground/60 mb-3">General Competitive Updates</h3>
