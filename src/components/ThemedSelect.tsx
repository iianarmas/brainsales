...
export function ThemedSelect({
    ...
    return (
        <div ref={dropdownRef} className={`relative inline-block text-left ${className}`}>
            ...
            {isOpen && (
                <div className="absolute left-0 mt-1 w-full min-w-[200px] bg-surface-overlay border border-border rounded-lg shadow-xl z-[100] overflow-hidden animate-in fade-in zoom-in-95 duration-100">
